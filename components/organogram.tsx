...
const LeadersSection: React.FC = () => {
  ...
  return (
    <section ref={sectionRef} className="py-12 px-4 md:px-8  w-fit mx-auto lg:px-16">
      <h2
        ref={headingRef}
        className=" text-4xl sm:text-5xl md:text-6xl font-bold text-center mb-12 bg-linear-to-r from-white via-[#e80500] to-[#1b2232] bg-clip-text text-transparent"
      >
        Meet our Leaders
      </h2>
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid grid-cols-1 gap-6 justify-center sm:grid-cols-2 lg:grid-cols-3">
          {leaders.slice(1, 10).map((leader, index) => (
            <div key={`leader-${index}`} className="w-80 h-80" data-leader-card>
