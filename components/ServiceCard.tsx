  ...
  return (
    ...
    >
      <div className="relative bg-white rounded-lg h-full p-6">
        ...
        <div className="w-16 h-16 rounded-full border border-blue-300 flex items-center justify-center mb-4 bg-linear-to-br from-white via-red-50 to-blue-50">
          {icon ? (
            ...
            <div className="w-12 h-12 rounded-full bg-linear-to-br from-(--secondary) to-[#1b2232]"></div>
          )}
        </div>
        ...
        <div className="absolute bottom-4 right-4">
          <svg
            ...
            className="h-6 w-6 text-gray-400 group-hover:text-(--secondary) transition-colors"
            fill="currentColor"
            viewBox="0 0 24 24"
          >
  ...
  return (
    <>
      <section className="relative z-10 bg-white px-8 sm:px-16 md:px-24 lg:px-32 py-16">
        <h2 className="text-4xl sm:text-5xl md:text-6xl font-bold text-center mb-12 bg-linear-to-r from-white via-[#e80500] to-[#1b2232] bg-clip-text text-transparent">
          {title}
        </h2>
      ...
      {isModalOpen && selectedService && (
        <ServiceModal
          ...
          description={selectedService.modalDescription || selectedService.description}
          additionalText={selectedService.additionalText}
          images={selectedService.modalImages}
        />
      )}
    </>
  );
